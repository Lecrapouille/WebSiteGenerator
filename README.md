...
This is my simple m4 tools for generating my web page.
...
The generated html pages are under the Creative Commons licence, as well as there sources (m4 files). 
